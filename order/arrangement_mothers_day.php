...
<section class="product_detail cc clearfix season">
  ...
  <h1><span><img src="<?php echo ROOT ?>img/season/ttl_mothers_day.png" alt="2018 Mother's Day (母の日)"></span>Arrangement</h1>
  ...
  <div class="colormejs clearfix">
		<script type='text/javascript' src='<?php echo $shop_url ?>?mode=cartjs&pid=<?php echo $product_id[5] ?>&style=basic&name=n&img=y&expl=n&stock=n&price=y&inq=n&sk=y' charset='euc-jp'></script>
  </div>
  <div class="paypal_info">
	  <p>
			<b><span>※</span>商品写真は5,000円のpinkになります</b><br>
