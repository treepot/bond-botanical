...
<meta name="keywords" content="bois de gui,北浜,花屋,フラワーショップ,おしゃれ,フラワーギフト,ブーケ,ウェディングブーケ,bond,レッスン,大阪,胡蝶蘭,観葉植物,<?php echo $title[$page] ?>">
<meta name="description" content="大阪 北浜にある花屋bois de gui（ボワドゥギ）はフラワーギフト、ウェディングブーケ、定期装花など色んなお花のご依頼におこたえします">
...
<link rel="stylesheet" href="<?php print ROOT ?>css/season.css">
...
if($page_dir == 'shop'){
	echo '<script src="https://maps.google.com/maps/api/js?key=AIzaSyDA9WV2vzhJM9dZRX0yK8hEaTYBAwQWHLE&sensor=true"></script>'; //google maps api
};
