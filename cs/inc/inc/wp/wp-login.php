<?php
include '/home/users/0/lolipop.jp-2684e7861272dde5/web/cs/inc/site.php';
/**
 * WordPress User Page
 *
...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	?>
	<div id="login">
		<h1><img src="http://bond-botanical.jp/cs/img/bois-de-gui-logo.png" width="50%" height="auto" style="padding:10px 0 20px;" ></h1>
	<?php
...
function login_footer($input_id = '') {
	...
	if ( ! $interim_login ): ?>
	<p id="backtoblog"><a href="<?php echo ROOT.'admin/'; ?>"><?php
