...
<section class="product_detail cc clearfix">
  ...
  <div class="colormejs clearfix">
		<script type='text/javascript' src='<?php echo $shop_url ?>?mode=cartjs&pid=<?php echo $product_id[0] ?>&style=basic&name=n&img=y&expl=n&stock=n&price=y&inq=n&sk=y' charset='euc-jp'></script>
  </div>
  ...
  <div class="detail">
  	<p>アレンジメントとは<br class="sp">器も込みでデザインされたお花の事<br>
    そのまま飾っていただけるので、<br class="sp">贈り物には最適です<br>
    開店御祝や楽屋お見舞いのお花<br class="sp">手土産などにもおすすめです</p>
    <p>その他、ロングタイプやお花の詳細など、ご指定がございましたら、<a href="<?php echo ROOT ?>order_sheet?flower_type=arrangement">こちら</a>からご注文ください</p>
  </div>
</section>
<?php
