...
<link rel="stylesheet" href="<?php echo ROOT ?>css/pc.css">
<link rel="stylesheet" href="<?php echo ROOT ?>css/sp.css">
<link rel="stylesheet" href="<?php echo ROOT ?>css/pad.css">
...
<link href="https://fonts.googleapis.com/css?family=Amiri|Open+Sans+Condensed:300" rel="stylesheet">
<script src="<?php print ROOT ?>js/jquery.min.js"></script>
<script src="<?php print ROOT ?>js/common.js"></script>
</head>

<body <?php body_class(); ?>>
<?php include ( ROOTDIR.'inc/site.php' ) ?>
