...
<section class="product_detail clearfix">
  ...
  <div class="detail2">
  	<p>開店御祝や年御祝、個展へのお祝いのお花など、とにかく目立たせたい！という時にお勧めです<br>
    <br>
    スタンド花　21,600円～<br>
    （画像のような器をご希望の場合、27,000円～）<br>
    <br>
    ご注文の場合、オーダーシートから<br>
    お電話でもお受けできます<br>
    TEL　06-6222-2287</p>
  </div>
  <a class="order" href="<?php echo ROOT ?>order_sheet?flower_type=stand_flower">Order Sheet</a>
</section>
<?php
